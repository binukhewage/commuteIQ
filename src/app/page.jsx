...
export default function Home() {
  ...
  return (
    <div className="h-screen w-screen bg-background text-foreground flex flex-col justify-between overflow-hidden relative font-sans select-none">
      ...
      {/* HEADER */}
      <header className="w-full bg-background/40 backdrop-blur-md border-b border-border z-20">
        <div className="max-w-6xl mx-auto px-6 h-16 flex items-center justify-between">
          <Link href="/" className="flex items-center gap-2.5 group">
            ...
            <span className="font-extrabold text-base tracking-tight bg-clip-text text-transparent bg-gradient-to-r from-foreground to-muted-foreground">
              CommuteIQ
            </span>
          </Link>
          ...
          <div className="flex items-center gap-3">
            {isLoggedIn ? (
              <Link
                href="/dashboard"
                className="bg-foreground text-background hover:bg-foreground/90 px-4 py-2 rounded-xl text-xs font-bold transition-all duration-300 flex items-center gap-1.5 shadow-md shadow-foreground/5"
              >
                <span>Dashboard</span>
              ...
              <>
                <Link
                  href="/login"
                  className="text-muted-foreground hover:text-foreground px-3 py-2 text-xs font-bold transition-colors"
                >
                  Log In
                </Link>
                <Link
      ...
      <main className="flex-1 max-w-6xl mx-auto w-full px-6 flex flex-col md:grid md:grid-cols-12 md:gap-10 items-center justify-center z-10 overflow-hidden py-4">
        ...
        <div className="md:col-span-6 flex flex-col items-center md:items-start text-center md:text-left space-y-6 max-w-lg md:max-w-none animate-slide-up">
          <div className="inline-flex items-center gap-2 px-3 py-1 bg-indigo-500/10 text-indigo-600 dark:text-indigo-400 text-[10px] font-bold rounded-full border border-indigo-500/25 w-fit">
          ...
          <div className="space-y-3.5">
            <h1 className="text-3xl sm:text-5xl font-black tracking-tight leading-[1.1] text-foreground">
              ...
              <span className="bg-clip-text text-transparent bg-gradient-to-r from-indigo-500 via-cyan-500 to-indigo-600">
                Commuters
              </span>
            </h1>
            <p className="text-muted-foreground text-xs sm:text-sm leading-relaxed max-w-md md:max-w-none">
          ...
          <div className="flex flex-col sm:flex-row items-center gap-3 w-full sm:w-auto pt-2">
            ...
            <Link
              href="/login"
              className="w-full sm:w-auto glass-panel border-border text-muted-foreground hover:text-foreground py-3 px-6 rounded-xl text-xs tracking-wider uppercase transition-all duration-300 flex items-center justify-center gap-2 hover:scale-[1.02] active:scale-[0.98] text-center"
            >
        ...
        <div className="md:col-span-6 w-full hidden md:block animate-scale-in">
          <div className="glass-panel rounded-3xl p-5 shadow-2xl relative overflow-hidden group">
            {/* Visual Glass Header */}
            ...
            <div className="grid grid-cols-3 gap-3.5 mb-4">
              <div className="bg-card/45 border border-border p-3.5 rounded-xl text-left">
                <div className="flex items-center justify-between text-muted-foreground mb-1.5">
                  <span className="text-[9px] font-bold uppercase">Monthly Kms</span>
                  <Milestone className="size-3.5 text-indigo-500" />
                </div>
                <p className="text-xl font-black text-foreground">480 KM</p>
                <div className="w-full bg-background h-1 rounded-full mt-2.5 overflow-hidden">
              ...
              <div className="bg-card/45 border border-border p-3.5 rounded-xl text-left">
                ...
                <p className="text-xl font-black text-foreground">32.8 L</p>
                <div className="w-full bg-background h-1 rounded-full mt-2.5 overflow-hidden">
              ...
              <div className="bg-card/45 border border-border p-3.5 rounded-xl text-left">
                ...
                <p className="text-xl font-black text-foreground">Rs. 13,448</p>
                <div className="w-full bg-background h-1 rounded-full mt-2.5 overflow-hidden">
            ...
            <div className="bg-card/25 border border-border rounded-xl p-3.5 space-y-2">
              <div className="flex justify-between items-center text-[10px] text-muted-foreground">
                <span className="font-semibold uppercase">Commute Efficiency Trend</span>
                <span className="text-emerald-500 font-bold">14.6 KM/L Average</span>
              </div>
              <div className="h-12 flex items-end gap-1.5 pt-2">
                <div className="bg-muted hover:bg-indigo-500/40 w-full h-[30%] rounded-sm transition-all" />
                <div className="bg-muted hover:bg-indigo-500/40 w-full h-[55%] rounded-sm transition-all" />
                <div className="bg-muted hover:bg-indigo-500/40 w-full h-[40%] rounded-sm transition-all" />
      ...
      <footer className="w-full border-t border-border bg-card py-4 z-20">
        <div className="max-w-6xl mx-auto px-6 flex flex-col sm:flex-row items-center justify-between gap-4 text-[10px] sm:text-xs text-muted-foreground/80 font-semibold uppercase tracking-wider">
