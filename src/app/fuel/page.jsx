            ...
            >
              ...
              <div>
                ...
                <div className="relative">
                  <input
                    ...
                    className="w-full p-3 rounded-xl bg-zinc-900 border border-zinc-800 text-xs font-bold focus:outline-none focus:border-indigo-500"
                  />
              ...
              <div>
                ...
                <div className="relative">
                  <input
                    ...
                    className="w-full p-3 pl-10 rounded-xl bg-zinc-900 border border-zinc-800 text-xs font-bold focus:outline-none focus:border-indigo-500"
                  />
              ...
              <div>
                ...
                <select
                  ...
                  className="w-full p-3 rounded-xl bg-zinc-900 border border-zinc-800 text-xs font-semibold focus:outline-none focus:border-indigo-500"
                >
              ...
              {litres && amountSpent && !isNaN(litres) && !isNaN(amountSpent) && (
                <div className="bg-cyan-950/20 border border-cyan-900/40 p-4 rounded-2xl space-y-2 text-xs transition-all duration-300">
          ...
          <div className="lg:col-span-2 space-y-4">
            ...
            {loading ? (
                    ...
                    >
                      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                        <div className="flex items-center gap-4">
                          ...
                          <div className="p-3 bg-zinc-900 border border-zinc-800 rounded-xl text-indigo-400 group-hover:scale-110 transition-transform">
              ...
              <div className="glass-panel border-dashed border-zinc-800 rounded-3xl p-12 text-center flex flex-col items-center justify-center space-y-3">
                ...
                <h3 className="font-bold text-sm text-zinc-400">No refuels logged yet</h3>
